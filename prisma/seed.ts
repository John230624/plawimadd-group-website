...
async function seedPermissionsAndRoles() {
  ...
  console.log(`✓ Rôle "Administrateur" créé avec ${allPermissions.length} permissions`);
  console.log(`✓ Rôle "Vendeur" créé avec ${allPermissions.filter((p) => sellerSlugs.has(p.slug)).length} permissions`);
}
