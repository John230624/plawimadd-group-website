  ...
  return (
    <div className="flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
      <div>
        ...
        <h1 className="mt-2 text-[2.2rem] font-semibold tracking-[-0.05em] text-slate-950 md:text-[2.9rem]">
          {title}
        </h1>
        {description ? (
          <p className="mt-3 max-w-[68ch] text-sm leading-7 text-slate-500 md:text-[0.97rem]">
            {description}
          </p>
        ) : null}
      </div>
