...
export default function AddressCheckoutModal({
  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center bg-slate-950/30 p-3 sm:p-4 backdrop-blur-sm">
      <div className="show-scrollbar flex max-h-[92vh] w-full max-w-[980px] flex-col overflow-y-auto rounded-lg bg-white shadow-[0_30px_90px_rgba(15,23,42,0.18)]">
        <div className="flex items-start justify-between border-b border-slate-200 px-5 py-4 sm:px-6 sm:py-5 md:px-8">
          <div>
            <h2 className="text-xl font-semibold tracking-[-0.04em] text-slate-950 sm:text-[1.8rem]">
        ...
        <div className="grid gap-0 lg:grid-cols-[1.05fr_0.95fr] text-left">
          ...
          <div className="bg-slate-50 p-5 sm:p-6 lg:p-8">
            <div className="rounded-lg bg-white p-5 sm:p-6 shadow-none border border-transparent">
