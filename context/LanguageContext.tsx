...
const translations: Record<Locale, Record<string, string>> = {
  fr: {
    ...
    'sidebar.purchasing': 'Achats',
    'sidebar.purchases': 'Achats fournisseurs',
    'sidebar.suppliers': 'Fournisseurs',
    'sidebar.posSession': 'Journal de caisse',
    'sidebar.receivables': 'Créances clients',
  ...
  en: {
    ...
    'sidebar.purchases': 'Supplier purchases',
    'sidebar.suppliers': 'Suppliers',
    'sidebar.posSession': 'Cash journal',
